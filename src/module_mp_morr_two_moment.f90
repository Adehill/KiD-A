...
!          END IF
      ...
      if ( nx == 1) then 
         call save_dg(k, pra(k), 'pra', i_dgtime, units='kg/kg/s')
         call save_dg(k, pre(k), 'pre', i_dgtime, units='kg/kg/s')
         call save_dg(k, prc(k), 'prc', i_dgtime, units='kg/kg/s')
         call save_dg(k, pcc(k), 'pcc', i_dgtime, units='kg/kg/s')
         call save_dg(k, npra(k), 'npra', i_dgtime, units='kg/kg/s')
         call save_dg(k, nsubr(k), 'nsubr', i_dgtime, units='kg/kg/s')
         ...
         call save_dg(k,ite, prc(k), 'prc', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, pcc(k), 'pcc', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, npra(k), 'npra', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, nsubr(k), 'nsubr', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, nsubc(k), 'nsubc', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, nprc(k), 'nprc', i_dgtime, units='kg/kg/s')
         call save_dg(k,ite, nprc1(k), 'nprc1', i_dgtime, units='kg/kg/s')
      endif
      !/KiD
