          ...
          if (nx == 1) then
             ...
             if (.not. iiwarm)then
                ...
                call save_dg(k, prr_gml(k), 'prr_gml', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, pnr_rcs(k), 'pnr_rcs', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, pnr_rcg(k), 'pnr_rcg', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, pnr_rci(k), 'pnr_rci', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, pnr_sml(k), 'pnr_sml', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, pnr_gml(k), 'pnr_gml', i_dgtime,  units='/kg&
                     &/s',dim='z')
             ...
             call save_dg(k, prv_rev(k), 'prv_rev', i_dgtime,  units='/kg&
              &/s',dim='z')
             call save_dg(k, pnr_wau(k), 'pnr_wau', i_dgtime,  units='/kg&
                  &/s',dim='z')
             call save_dg(k, pnr_rev(k), 'pnr_rev', i_dgtime,  units='/kg&
                  &/s',dim='z')
             ...
             if (.not. iiwarm)then
                ...
                call save_dg(k, ii, prr_gml(k), 'prr_gml', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, ii, pnr_rcs(k), 'pnr_rcs', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, ii, pnr_rcg(k), 'pnr_rcg', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, ii, pnr_rci(k), 'pnr_rci', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, ii, pnr_sml(k), 'pnr_sml', i_dgtime,  units='/kg&
                     &/s',dim='z')
                call save_dg(k, ii, pnr_gml(k), 'pnr_gml', i_dgtime,  units='/kg&
                     &/s',dim='z')
             ...
             call save_dg(k, ii, prv_rev(k), 'prv_rev', i_dgtime,  units='/kg&
                  &/s',dim='z')
             call save_dg(k, ii, pnr_wau(k), 'pnr_wau', i_dgtime,  units='/kg&
                  &/s',dim='z')
             call save_dg(k, ii, pnr_rev(k), 'pnr_rev', i_dgtime,  units='/kg&
                  &/s',dim='z')
             call save_dg(k, ii, pnr_rcr(k), 'pnr_rcr', i_dgtime,  units='/kg&
                  &/s',dim='z')
          endif
